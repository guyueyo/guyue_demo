...
public class Utils {
	public enum Theme {
		BLUE("Blue Theme", false), GRAY("Gray Theme", false), NEPTUNE("Neptune Theme", true), TRITON("Triton Theme", true),GUYUE("Red Theme",true);
	...
	public interface ActiveTheme extends BindingPropertySet {
		...
		@PropertyValue(value = "red",warn = false)
		boolean isGuyue();
	}
}
